...
struct PrivacyPolicyView: View {
    ...
    var body: some View {
        VStack {
            ...
            NavigationLink(destination: SignUpView(user: user).navigationTitle("회원가입").navigationBarTitleDisplayMode(.inline), isActive: $showingSignUpView) {
                EmptyView()
            }
