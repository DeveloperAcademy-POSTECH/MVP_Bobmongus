...
struct EditProfileView: View {
    ...
    @State private var canEditPassword = true
        ...
        VStack {
            ...
            VStack {
                ...
                .alert(isPresented: $checkPassword) {
                    if typedPassword == originPassword {
                        var canEditPassword = true
                        print ("hi")
                ...
                VStack {
                    ...
                    .alert(isPresented: $editPassword) {
                        if newPassword1 == newPassword2 {
                            return Alert(title: Text("비밀번호 변경"), message: Text("비밀번호가 변경되었습니다!"), dismissButton: .default(Text("확인")))
                        } else {
