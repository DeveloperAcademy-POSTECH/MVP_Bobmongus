...
struct TestRoomListView: View {
    ...
    @State var newRoom: Room = Room(id: 100, isStart: false, roomTitle: "title", roomDetail: "detail", nowPersons: [], persons: 100, endTime: 100, linkURL: "linkURL", roomTimeStr: "4/12/2022, 5:51:00 AM")
    
    
//    @State private var roomTime = getNowDateTime24().components(separatedBy: ":")
...
//                .foregroundColor(.white)
            ...
            HStack {
                ...
                Text("\(room.nowPersons.count)명/\(room.persons)명") // 인원수
                    .font(.custom("NEXON Lv2 Gothic OTF", size: 12))
                    .frame(width: 50)
